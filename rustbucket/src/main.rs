...
fn main() {
    let new_clone_database_instance_name = "fakedb-1";
    let old_clone_database_instance_name = "fakedb-2";
    ...
    let create_db_cluster_clone_request = RestoreDBToPointInTimeMessage {
        db_cluster_identifier: Some(5),
